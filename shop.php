 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="">  
                <h3 align="center">ISP Materials:Shopping Cart of Drishti Parenting </h3><br /> 
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="shop.php?action=add&sno=<?php echo $row["sno"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                                
                               <h4 class="text-info"><?php echo $row["name"]; ?></h4> 
                               <h4 class="text-info"><?php echo $row["language"]; ?></h4>
                               <h4 class="text-info"><?php echo $row["number"]; ?></h4>
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="shop.php?action=delete&sno=<?php echo $values["sno"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
